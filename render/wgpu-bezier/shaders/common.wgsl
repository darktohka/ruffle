/// Common WGSL shared among all Bézier-based Ruffle shaders.
/// This is prepended to each shader at compilation time.
...
/// Transform uniforms that are changed per draw call / object.
